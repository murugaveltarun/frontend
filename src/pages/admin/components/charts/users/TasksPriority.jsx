...
const COLORS = ["var(--color-priority-high)", "var(--color-priority-low)", "var(--color-priority-medium)"]; // replace with your own colors

export default function TasksPriority() {
  const { stats } = useContext(StatsContext);
  const authProviders = stats?.tasks?.priority || [];
