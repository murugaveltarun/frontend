...
function AdminHeader({ sideBarOpen, setSideBarOpen, theme, setTheme }) {
  ...
  return (
    <header className="p-8 flex justify-between h-30 items-center ">
      ...
      <h5 className="cursor-pointer flex flex-row justify-center items-center gap-4 text-xl  m-2 md:m-6 sm:text-4xl md:text-5xl font-bold text-accent dark:text-gradient select-none" onClick={()=>navigate("")}> <ListTodo className="dark:text-gradient-mid-color sm:w-11 sm:h-11  md:w-14 md:h-14" /> <span>Task Wiser </span> </h5>
